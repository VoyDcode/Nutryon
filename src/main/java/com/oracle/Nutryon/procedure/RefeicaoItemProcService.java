...
@Service
public class RefeicaoItemProcService {
  private final SimpleJdbcCall insertCall, updateQtyCall, deleteCall;

  public RefeicaoItemProcService(JdbcTemplate jdbc) {
  ...
  public void insert(long mealId, long ingredientId, double quantity, long unitId) {
    insertCall.execute(Map.of(
      "p_id_refeicao", mealId,
      "p_id_ingrediente", ingredientId,
      "p_qtde", quantity,
      "p_id_unidade", unitId
    ));
  }
